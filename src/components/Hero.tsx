    ...
    <section className="relative bg-gradient-hero-neon text-text py-20 md:py-32 rounded-2xl shadow-neon-glow-lg shadow-primary overflow-hidden animate-fadeInUp">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-16">
          <Button asChild size="lg" className="bg-primary text-white hover:bg-primary/90 shadow-neon-glow shadow-primary animate-slideInLeft">
            <Link to="/charities">
              <Handshake className="mr-2" size={24} />
              Browse Charities
            </Link>
          </Button>
          <Button asChild variant="outline" size="lg" className="border-secondary text-secondary hover:bg-secondary/10 hover:text-white shadow-neon-glow shadow-secondary animate-slideInRight">
            <Link to="/dashboard">
